...
To test different trace workloads, user can replace the workload file (exp) in the HTTP client folder. By default, the workload is generated by Huawei trace, and we offer an Azure-generated workload (azure) in the same folder.